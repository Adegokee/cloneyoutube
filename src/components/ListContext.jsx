...
const api_key = '?part=snippet&key=AIzaSyBrae2VzoOcRy4PJCvgUUwBcS-v8cVZR5Y&q='
...
const ListContext = () => {
    ...
    useEffect(() =>{
        const getMovie = async () => {
            ...
            // 'https://youtube.googleapis.com/youtube/v3/search?part=snippet&key=AIzaSyBrae2VzoOcRy4PJCvgUUwBcS-v8cVZR5Y&q'
